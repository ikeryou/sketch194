...
export class Con extends Canvas {
  ...
  protected _update(): void {
    ...
    if(Conf.instance.FLG_TEST) {
      this._move.x = Param.instance.particle.x.value * 0.01 * w * 1
      this._move.y = Param.instance.particle.y.value * 0.01 * w * 1
    }
  ...
  public getGeo():BufferGeometry {
    ...
    while(i < num) {
        ...
        info[pKey*3+0] = 1 + Util.instance.random(0, 1)
        info[pKey*3+1] = 1 + Util.instance.random(0, 1)
        info[pKey*3+2] = 0
